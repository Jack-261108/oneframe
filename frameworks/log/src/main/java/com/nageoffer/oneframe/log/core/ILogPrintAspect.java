...
package com.nageoffer.oneframe.log.core;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.date.SystemClock;
import com.alibaba.fastjson2.JSON;
import com.nageoffer.oneframe.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.nageoffer.oneframe.log.annotation.ILog) || @annotation(com.nageoffer.oneframe.log.annotation.ILog)")
